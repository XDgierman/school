...
--
-- Host: 127.0.0.1
-- Czas generowania: 29 Maj 2018, 13:08
...
INSERT INTO `rowery` (`IDroweru`, `NazwaRoweru`, `OpisRoweru`, `DataDodania`, `IDkategorii`, `IDproducenta`, `CenaJednostkowa`, `ZdjecieRoweru`) VALUES
(1, 'Magnum', 'Rower ze stali tytanowej, odpornej na korozję', '2017-02-02', 2, 1, '1600.00', NULL),
(2, 'Enigma', 'Rower roku 2013', '2017-02-02', 4, 3, '700.00', NULL),
(3, 'Relaks', 'Rower treningowy z możliwością regulacji oporu koła', '2017-02-02', 4, 2, '1200.00', NULL),
(4, 'Bobo', 'Lekki rower ze stali aluminiowej', '2017-02-02', 5, 1, '360.00', NULL),
(5, 'Huragan', 'Rower wyścigowy 30 biegowy', '2017-02-02', 3, 5, '3300.00', NULL),
(6, 'Junak', 'Idealny rower na górskie wycieczki', '2017-02-02', 1, 4, '1000.00', NULL),
(7, 'Mirage', 'Wysokiej klasy rower wyczynowy dla profesjonalistów', '2017-02-02', 1, 4, '900.00', NULL);
...
--
ALTER TABLE `wojewodztwa`
  MODIFY `IDwojewodztwa` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;COMMIT;
