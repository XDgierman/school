	...
	<div>
		...
		<?php
			...
			#Ustalenie nazwy obrazka i jego wyświetlenie
  			...
  			echo " <a href=\"index.php?img_id=$poprzedni\">Poprzedni</a> | ";
  			echo " <a href=\"index.php?img_id=$nastepny\">Następny</a> ";
		?>
		<form>
			<a href="innaGaleria.html"><input type="button" value="Następne"></a>
		</form>	
